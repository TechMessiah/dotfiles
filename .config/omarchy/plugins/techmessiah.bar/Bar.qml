...
Item {
  ...
  // Not `required`: the third-party bar Loader sets these imperatively
  // after construction (Loader.source + configureBar), which a `required`
  // property rejects with "was not initialized" and the surface never maps.
