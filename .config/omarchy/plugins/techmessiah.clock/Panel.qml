...
Panel {
  ...
  component TopRightPanel: PanelWindow {
    ...
    // Centered on screen, unlike the other panels: the calendar is a
    // read-it-then-dismiss surface rather than a set of controls tied to its
    // bar button, and its button sits in the bar's centre section anyway.
